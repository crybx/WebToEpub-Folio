...
test("update", function (assert) {
    let chapterList = [
        {isIncludeable: false, sourceUrl: "https://novelupdates.com/seriesPage.html"},
        {isIncludeable: true, sourceUrl: "https://mySite.org/s1/chapter_001.html"},
        {isIncludeable: false, sourceUrl: "https://mySite.org/s1/chapter_002.html"},
    ];

    let toc1Url = "httpss://mySite.org/s1/toc.html";
    let rl = new ReadingList();
    rl.addEpub(toc1Url);
    rl.update(toc1Url, chapterList);
    let actual = rl.getEpub(toc1Url);
    assert.equal(actual, "https://mySite.org/s1/chapter_001.html");

    chapterList.push({isIncludeable: true, sourceUrl: "https://mySite.org/s1/chapter_003.html"})
    rl.update(toc1Url, chapterList);
    actual = rl.getEpub(toc1Url);
    assert.equal(actual, "https://mySite.org/s1/chapter_003.html");
});
...
test("deselectOldChapters", function (assert) {
    ...
    let pages = [
        { sourceUrl: "https://novelupdates.com/seriesPage.html",  isIncludeable: false },
        { sourceUrl: "https://mySite.org/s1/chapter_001.html",  isIncludeable: true },
        { sourceUrl: "https://mySite.org/s1/chapter_002.html",  isIncludeable: true },
        { sourceUrl: "https://mySite.org/s1/chapter_003.html",  isIncludeable: true },
        { sourceUrl: "https://mySite.org/s1/chapter_004.html",  isIncludeable: false }
    ];

    let toc1Url = "https://mySite.org/s1/toc.html";
    let rl = new ReadingList();
    rl.addEpub(toc1Url);
...
test("toJson", function (assert) {
    ...
    readingList.update(toc2Url, [
        { isIncludeable: true, sourceUrl: "https://novelupdates.com/series2Page.html" },
        { isIncludeable: true, sourceUrl: "https://mySite.org/s2/chapter_001.html" },
        { isIncludeable: true, sourceUrl: "https://mySite.org/s2/chapter_002.html" },
    ]);

    let actual = readingList.toJson();
    assert.equal(actual, "{\"epubs\":["+
        "{\"toc\":\"" + toc1Url + "\",\"lastUrl\":\"https://mySite.org/s1/chapter_001.html\"},"+
        "{\"toc\":\"" + toc2Url + "\",\"lastUrl\":\"https://mySite.org/s2/chapter_002.html\"}"+
        "]}"
    );
